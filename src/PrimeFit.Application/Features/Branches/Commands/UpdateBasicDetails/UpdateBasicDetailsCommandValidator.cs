...
{
    public class UpdateBasicDetailsCommandValidator : AbstractValidator<UpdateBasicDetailsCommand>
    {
        private readonly IPhoneNumberService _phoneNumberService;

        public UpdateBasicDetailsCommandValidator(IPhoneNumberService phoneNumberService)
        {
        ...
        private bool HaveAtLeastOneNonNullProperty(UpdateBasicDetailsCommand command)
        {
