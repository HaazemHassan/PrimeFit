...
namespace PrimeFit.Infrastructure.Migrations
{
    ...
    [Migration("20260623145029_Add index on ProcessedOnUtc in OutboxMessage table")]
    partial class AddindexonProcessedOnUtcinOutboxMessagetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimeFit.Domain.Entities.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PaymentTransactions", "payments", t =>
                        {
            ...
            modelBuilder.Entity("PrimeFit.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("NextProcessingDate")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("NextProcessingDate", "Id")
                        .HasDatabaseName("IX_Subscriptions_Job_Processing")
                        .HasFilter("[NextProcessingDate] IS NOT NULL AND [Status] <> 3 AND [Status] <> 4");
            ...
            modelBuilder.Entity("PrimeFit.Domain.Entities.SubscriptionFreeze", b =>
                {
                    ...
                    b.HasIndex("SubscriptionId", "EndDate")
            ...
            modelBuilder.Entity("PrimeFit.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrimeFit.Domain.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrimeFit.Infrastructure.Data.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
